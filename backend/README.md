...
Voice uploads are transcribed through the same OpenRouter model before the normal assistant/tool loop runs.
...
- `OPENROUTER_MODEL` (defaults to `mistralai/voxtral-small-24b-2507`)
